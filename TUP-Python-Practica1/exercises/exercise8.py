...
# COMPLETAR - INICIO
lista1=["cafetera", "TV 50 pulgadas", "mouse gamer"]
lista2=["ipad", "ipod", "iphone"]
lista3=["Reproductor de CD", "Videograbadora"]

Compras = {}
Compras = {"Mario Pedernera":lista1,
          "Ezequiel Castello":lista2,
          "Pablo Piristrelli":lista3,
          }
